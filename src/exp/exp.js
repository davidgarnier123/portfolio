...
class Exp extends React.Component {
    render() {
        return <div className='h-max flex justify-center items-center pt-6 pb-6 flex-col'>
            ...
            <div className='xl:w-3/5 lg:w-5/5 md:w-5/5 bg-cliffordLight md:bg-clifford flex flex-col p-6 duration-300 md:rounded-lg drop-shadow-shadow'>
                ...
                <div className='p-2 pb-8 pt-8 md:p-6'>
