    ...
    render() {
        return <div className='h-max flex items-center pt-6 pb-6 flex-col' id="content">
            ...
            <div className='flex lg:flex-row sm:flex-col flex-col justify-center flex-wrap'>
                ...
                <Poc id={2} title={'Jeu asteroïdes'} desc={`Petit jeu en 2d avec la librairie Phaser`} link={'https://daga123-asteroids.web.app/'} technos={['Angular', 'Phaser']} github={'https://github.com/davidgarnier123/asteroid'}></Poc>
            </div>
        </div>
            ;
    }
