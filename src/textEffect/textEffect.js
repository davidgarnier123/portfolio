...
const TextEffect = () => {
  ...
  return (
    <div className="h-full flex justify-center items-center">
      <h1 className="text-orange text-4xl relative inline-block md:text-5xl font-semibold text-orange tracking-wider">
        <span id="before-te1" className="absolute top-0 left-0.5 w-full h-full bg-transparent" style={{ textShadow: "-2px 0 #98C1D9", clipPath: "rect(24px, 550px, 90px, 0)" }} aria-hidden="true">David Garnier</span> {/* glitch::before */}
        David Garnier
        <span id="after-te1" className="absolute top-0 -left-0.5 w-full h-full bg-transparent" style={{ textShadow: "-2px 0 spin(#98C1D9, 180)", clipPath: "rect(85px, 550px, 140px, 0)" }} aria-hidden="true">David Garnier</span> {/* glitch::after */}
      </h1>
    </div>
  )
}
